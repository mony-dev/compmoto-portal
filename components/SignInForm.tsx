    ...
    <>
      <div className="w-full max-w-md sm:max-w-lg mx-auto">
        <div className="mb-4 text-center">
          <span className="font-semibold text-xl sm:text-2xl default-font">
        ...
        >
          <div className="space-y-4">
            <Form.Item<FieldType>
              ...
              className="mb-0"
              rules={[
                { required: true, message: t("please_input_your_custNo") },
              ]}
            >
              <Input
          ...
          <Button
            type="primary"
            className="w-full flex items-center justify-center bg-black mt-6 h-11 sm:h-12 rounded-lg"
            htmlType="submit"
            loading={isLoading}
