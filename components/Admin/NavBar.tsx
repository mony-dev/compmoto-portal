      ...
      >
        <div className="flex flex-wrap items-center justify-between p-2 mx-auto">
          ...
          <div className="flex p-2.5 gap-2">
            ...
            >
              {profileImage ? (
                <div className="relative w-8 h-8 rounded-full overflow-hidden border border-[#fcd00d]">
                  <Image
            ...
            {isDropdownVisible && (
              <div
                ref={dropdownRef}
                className="absolute bg-white top-16 right-2 sm:right-8 rounded-lg z-40 w-[92vw] sm:w-auto max-w-md"
              >
